...
void ScoreWorkingCandidateOnTrainingSet(void)
{
    ...
    if (numWrong > 0) {
        // worse to make wrong predictions than no predictions *for this algorithm*
    }
    else {
