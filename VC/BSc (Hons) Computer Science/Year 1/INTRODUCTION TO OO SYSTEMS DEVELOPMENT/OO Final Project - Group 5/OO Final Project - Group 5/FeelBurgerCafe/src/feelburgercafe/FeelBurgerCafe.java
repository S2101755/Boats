 ...
 */
package feelburgercafe;//final.final
...
public class FeelBurgerCafe {
    ...
    private static ArrayList<FoodItem> masterList = new ArrayList<>();
    private static ArrayList<FoodOrder> foodOrders = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        masterList.add(new FoodItem("FC Burger", 60.00));
        ...
        masterList.add(new FoodItem("DM Burger", 85.00));
